...
{
    public class SplinterBullet  : Bullet
    {
        /// <summary>
        /// Жирный конструктор
        /// </summary>
        ...
        {
            return new SplinterBullet(position, target, Speed, Damage, DamageRadius);
        }
        ...
        public override void Draw(Canvas canvas)
        {
            if (!visualsCreated)
            {
                ...
                bullet.Source = new BitmapImage(new Uri("/images/splinter.png", UriKind.Relative));
