...
namespace NRTowerDefense
{
    public class SimpleBullet : Bullet
    {
        ...
        public SimpleBullet(Point position, Monster target, GameCell speed, double damage, GameCell damageRadius)
        ...
        {
            return new SimpleBullet( position, target, Speed, Damage, DamageRadius );
        }
        ...
        public override void Draw(Canvas canvas)
        {
            if (!visualsCreated)
            {
                ...
                bullet.Source = new BitmapImage(new Uri("/images/bullet5.png", UriKind.Relative));
